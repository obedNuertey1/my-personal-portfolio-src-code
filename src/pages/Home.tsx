...
const ArticleSectionComponent = ({articles}:any):JSX.Element=>(
...
const ProjectsSectionComponent = ():JSX.Element=>(
    <section id="projects" className="homepage-section pt-12 relative">
        ...
        <div id="show-projects" className="project flex flex-col sm:flex-row overflow-y-auto sm:overflow-x-auto max-w-w100 mx-auto select-none">
            <div className="current-projects">
                <iframe  className="rounded-md shadow-md" src="https://obn-calculator-app.netlify.app/" title="calculator" allowFullScreen frameBorder={0} sandbox="allow-same-origin allow-scripts"></iframe>
            </div>
    ...
    return (
        <>
            ...
            <div data-testid="home-section" id="home-section" className="page">
                ...
                <ArticleSectionComponent articles={articles} />

        ...
        <>
            <div data-testid="home-section" id="home-section" className="page">
                ...
                <section id="projects" className="homepage-section pt-12 relative">
                    <div className="iframe-nav absolute w-auto h-1/2 bottom-1/4 left-0 bg-gray-200 opacity-50 py-32 px-2 text-4xl text-gray-700 rounded-md"><p className="text-center"><FontAwesomeIcon icon={faArrowCircleLeft} /></p></div>
                    <div className="iframe-nav absolute w-auto h-1/2 bottom-1/4 right-0 bg-gray-200 opacity-50 py-32 text-4xl text-gray-700 px-2 rounded-md"><p className="text-center"><FontAwesomeIcon icon={faArrowCircleRight} /></p></div>
